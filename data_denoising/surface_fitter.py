...
#Melissa: uncomment this line to use in ssh linux server
matplotlib.use('Agg') 
...
class SurfNN():
    ...
    def load_data(self):
        ...
        # import data file
        # Melissa: add allow_pickle=True
        data = np.load(self.data_dir+'/'+self.data_name+'.npy', allow_pickle=True).item()
        ...
        #Melissa: allow_pickle=True
        data = np.load(self.data_dir+'/'+name, allow_pickle=True).item()
